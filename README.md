...
├── paraphrase-multilingual-mpnet-base-v2/                  # 预训练向量模型（paraphrase-multilingual-mpnet-base-v2）
├── vosk-model-small-cn-0.22/             # Vosk 语音识别模型（中文）
├── static/                  # Web 静态资源
│   ├── css/
│   └── js/
├── templates/               # Web 模板文件
...
### 模型和索引
- 向量模型已预置在 `paraphrase-multilingual-mpnet-base-v2/` 目录
- 语音识别模型已预置在 `vosk-model-small-cn-0.22/` 目录
